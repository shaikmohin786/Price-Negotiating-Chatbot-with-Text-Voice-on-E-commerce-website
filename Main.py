...
def ChatData():
    if request.method == 'GET':
        ...
        if 'price' in query.lower():
            output = "You can get product at ₹:"+str(predicted_price)  # Changed $ to ₹
        if "final" in query.lower() or "discount" in query.lower() or "my" in query.lower():
            ...
            output = "The final price you can get this product is ₹:"+str(predicted_price)  # Changed $ to ₹
...
def BrowseProducts():
    if request.method == 'GET':
        ...
        for i in range(len(dataset)):
            ...
            output+="<td>"+font+"₹"+price+"</font></td>"  # Changed $ to ₹
